...
// Handle file upload for the image COLLATE=utf8mb4_0900_ai_ci
...
if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
    ...
    $sql = "INSERT INTO complaintform (name, email, contact, date, location, `complaint details`, image) VALUES ('$name', '$email', '$contact', '$date', '$location', '$complaint', '$imagePath')";
